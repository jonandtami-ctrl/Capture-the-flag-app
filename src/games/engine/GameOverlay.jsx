export default function GameOverlay({ show, emoji, title, subtitle, buttonLabel, onAction, children }) {
  if (!show) return null
  return (
    <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-3 overflow-y-auto rounded-2xl bg-dusk-950/85 p-4 text-center backdrop-blur-sm">
